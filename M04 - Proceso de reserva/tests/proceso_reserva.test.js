const { validarEmail, cumpleAntelacionMinima, estaHorarioDisponible, esCancelable, buscarReservasPorEmail, solicitarCancelacion, confirmarCancelacion } = require('../src/proceso_reserva');
